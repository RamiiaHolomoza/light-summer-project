...
`;document.head.appendChild(y);let l=0,a=0;async function p(t=0,e=4){try{const n=(await x.get("https://portfolio-js.b.goit.study/api/reviews")).data;if(l=n.length,l===0)A("Not found");else{const i=n.slice(t,t+e);T(i),w(e)}}catch{j("Failed to load reviews. Please try again.")}}function T(t){const e=document.querySelector(".swiper-wrapper");e.innerHTML="",t.forEach(o=>{const n=document.createElement("li");n.classList.add("swiper-slide","review-item"),n.innerHTML=`
      <div class="review-item-content">
        <img class="image-reviews" src="${o.avatar_url}" alt="${o.author}">
        <b class="name-reviews">${o.author}</b>
        <p class="text-reviews">${o.review}</p>
      </div>`,e.appendChild(n)}),c.update()}function A(t){const e=document.querySelector(".swiper-wrapper"),o=document.createElement("li");o.classList.add("swiper-slide","review-item"),o.textContent=t,e.appendChild(o)}function j(t){const e=document.querySelector(".error-popup");e.textContent=t,e.classList.add("active"),setTimeout(()=>{e.classList.remove("active")},3e3)}function w(t){const e=document.querySelector(".swiper-button-prev"),o=document.querySelector(".swiper-button-next");a===0?e.classList.add("swiper-button-disabled"):e.classList.remove("swiper-button-disabled"),a+t>=l?o.classList.add("swiper-button-disabled"):o.classList.remove("swiper-button-disabled")}const c=new m(".reviews-slider",{slidesPerView:4,spaceBetween:16,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},keyboard:{enabled:!0,onlyInViewport:!0},breakpoints:{320:{slidesPerView:1},768:{slidesPerView:2,spaceBetween:16},1440:{slidesPerView:4,spaceBetween:16}},on:{slideChange:()=>w(c.params.slidesPerView)}});document.querySelector(".swiper-button-next").addEventListener("click",()=>{const t=c.params.slidesPerView;a+t<l&&(a+=t,p(a,t))});document.querySelector(".swiper-button-prev").addEventListener("click",()=>{const t=c.params.slidesPerView;a>0&&(a-=t,p(a,t))});const M=c.params.slidesPerView;p(a,M);
